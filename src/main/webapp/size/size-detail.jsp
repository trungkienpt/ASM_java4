...
<form action="/size/update" method="post">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="id" value="${s.id}">
    </div>
    <div class="mb-3">
    ...
    <div class="row">
        ...
        <div class="form-check col-4">
            <input class="form-check-input" type="radio" value="Active" name="trangThai" <c:if test="${s.trangThai == 'Active'}">checked</c:if> >
            <label class="form-check-label">
                Active
            </label>
        </div>
        <div class="form-check col-4">
            <input class="form-check-input" type="radio" value="Inactive" name="trangThai" <c:if test="${s.trangThai == 'Inactive'}">checked</c:if> >
            <label class="form-check-label">
                Inactive
            </label>
        </div>
